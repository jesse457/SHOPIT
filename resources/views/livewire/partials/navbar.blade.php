<header class="sticky inset-x-0 z-50 flex flex-wrap w-full top-4 md:justify-start md:flex-nowrap">
    <nav class="relative max-w-[80rem] w-full bg-blue-400 rounded-[28px] py-3 ps-5 pe-2 md:flex md:items-center md:justify-between md:py-0 mx-2 lg:mx-auto font-poppins font-extrabold"
        ...
        <div class="flex items-center justify-between">
            <!-- Logo -->
            <a wire:navigate
                class="flex-none inline-block text-xl font-semibold rounded-md focus:outline-none focus:opacity-80"
        ...
        <div id="navbar-collapse"
            ...
            <div
                ...
                <a wire:navigate
                    class="{{ request()->is('/') ? 'focus:text-neutral-800 text-neutral-800' : 'text-gray-100' }} text-sm hover:text-neutral-700 md:py-4 focus:text-neutral-300"
                ...
                <a wire:navigate
                    class="{{ request()->is('products') ? 'focus:text-neutral-800 text-neutral-800' : 'text-gray-100' }} text-sm hover:text-neutral-700 md:py-4 focus:text-neutral-300"
                    href="{{route('products')}}">Products</a>
                <a wire:navigate
                    class="{{ request()->is('categories') ? 'focus:text-neutral-800 text-neutral-800' : 'text-gray-100' }} text-sm hover:text-neutral-700 md:py-4 focus:text-neutral-300"
                    href="{{route('categories')}}">Categories</a>
                <a class="flex items-center text-sm {{ request()->is('cart') ? 'focus:text-neutral-800 text-neutral-800' : 'text-gray-100' }}  hover:text-neutral-700 md:py-4 focus:text-neutral-300"
                    href="{{route('cart')}}">
                ...
                @auth
                    ...
                    <div>
                        <a class="font-montserrat group inline-flex items-center gap-x-2 py-2 px-3 bg-[#ffffff] font-medium text-sm text-neutral-800 rounded-full focus:outline-none"
                ...
                @guest
                    <div>
                        <a wire:navigate class="group inline-flex items-center gap-x-2 py-2 px-3 bg-[#ffffff] font-medium text-sm text-neutral-800 rounded-full focus:outline-none"
                            href="login">
                            Login
                        </a>
                    </div>
