            ...
            <div class="sticky top-0 z-50 overflow-hidden ">
              ...
              <div class="flex-wrap hidden md:flex ">
                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{url('storage', $image)}}'">
                  <img src="{{url('storage',$image)}}" alt="{{$products->name}}" class="object-cover w-full cursor-pointer lg:h-20 hover:border hover:border-blue-500">
                </div>
              @endforeach
          ...
          <div class="w-full px-4 md:w-1/2 ">
            <div class="lg:pl-20">
              ...
              <div class="flex flex-wrap items-center gap-4">
                <button wire:click.prevent='addToCart({{ $products->id }})'  class="w-full p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
