            ...
            <form wire:submit.prevent='save'>
              <div class="grid gap-y-4">
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <div class="absolute inset-y-0 flex items-center pointer-events-none end-0 pe-3">
                        <svg class="w-5 h-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="false">
                  ...
                  @error('name')
                  <p class="mt-2 text-xs text-red-600 " id="email-error">please input a valid name </p>
                  @enderror
                ...
                <div>
                  ...
                  @error('email')
                  <p class="mt-2 text-xs text-red-600 " id="email-error">The email has already been taken</p>
                  @enderror
                ...
                <div>
                  ...
                  @error('password')
                  <p class="mt-2 text-xs text-red-600 " id="password-error">8+ characters required</p>
                </div>
                  @enderror
