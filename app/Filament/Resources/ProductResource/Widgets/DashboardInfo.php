...
protected function getStats(): array
{
    ...
    // Generate an icon based on the difference between the current and previous total of orders
      if(abs($percentageChange) > 0){
         $icon ='heroicon-m-arrow-trending-up';
                }
                else if(abs($percentageChange) == 0){
    ...
    // Generate a color based on the difference between the current and previous total of orders
    if(abs($percentageChange) > 0){
        $color ='success';
               }
               else if(abs($percentageChange) == 0){
