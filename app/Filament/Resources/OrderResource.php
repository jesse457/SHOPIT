...
class OrderResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                // Group to hold related form fields
                Group::make([
                    // Section to group related form fields together
                    Section::make('Order Information')->schema([
                        ...
                        // Select field for shipping method
                        ...
                        ->columns(2), // Arrange the fields in 2 columns
                    ...
                    ->columnSpanFull(), // Fill the entire form width
            ]);
    }
